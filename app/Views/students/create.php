...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row ">
        <div class="col-md-12">
            <fieldset>
                <legend>Aluno</legend>
                <form action="<?= base_url('student-add') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="mb-3 row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Nome</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nome "><br>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="address" name="address" placeholder="Endereço"><br>
